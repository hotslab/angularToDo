  ...
  <div class="container-fluid m-0 p-3 d-flex flex-column justify-content-center align-items-center">
    <div class="text-light bg-black d-flex justify-content-between align-items-center w-100 p-3 rounded flex-wrap">
      ...
      <div class="d-flex justify-content-end align-items-center">
        ...
        <a *ngIf="!editing" (click)="openEditing()" class="btn btn-sm btn-success ms-3">Edit</a>
      </div>
    </div>
    ...
    <div *ngIf="editing" class="card mt-5 w-50">
      <div class="card-body">
      ...
      <div class="card-footer text-body-secondary d-flex justify-content-end align-items-center">
        <button type="button" class="btn btn-danger" (click)="reset(); toDoForm.reset()">Reset</button>
...
export class TodoComponent implements OnInit {
  ...
  openEditing() {
    ...
    this.editingToDo.date = formatDate(date, 'yyy-MM-dd', 'en-US')
  ...
  onSubmit() {
    ...
    if (new Date(dateTime).getTime() < new Date().getTime()) this.errorMessage = 'The time set is in the past'
    else {
  ...
  goBackOrCancel() {
    ...
    if ((this.toDo && !this.editing) || (!this.toDo && this.editing)) this.router.navigate(['/todos'])
  }
  getToDo() {
    this.loading = true
